(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.FreeformControls = {}, global.THREE));
    ...
    ***************************************************************************** */
    ...
    var Cone = /** @class */ (function (_super) {
        ...
        function Cone(color) {
            ...
            _this.geometry = new THREE.ConeGeometry(DEFAULT_CONE_RADIUS, DEFAULT_CONE_HEIGHT, DEFAULT_RADIAL_SEGMENTS);
    ...
    })(exports.DEFAULT_HANDLE_GROUP_NAME || (exports.DEFAULT_HANDLE_GROUP_NAME = {}));
    /**
    ...
    var Octahedron = /** @class */ (function (_super) {
        ...
        function Octahedron(color) {
            var _this = _super.call(this) || this;
            _this.geometry = new THREE.OctahedronBufferGeometry(DEFAULT_OCTAHEDRON_RADIUS, 0);
    ...
    var Plane = /** @class */ (function (_super) {
        ...
        function Plane(color, width, height) {
            ...
            var _this = _super.call(this) || this;
            _this.geometry = new THREE.PlaneGeometry(width, height, DEFAULT_PLANE_SEGMENTS);
            _this.material = new THREE.MeshBasicMaterial({
                color: color,
                depthTest: false,
                side: THREE.DoubleSide,
    ...
    })(exports.ANCHOR_MODE || (exports.ANCHOR_MODE = {}));
    /**
    ...
    var Controls = /** @class */ (function (_super) {
        ...
        function Controls(object, camera, options) {
            ...
            _this.setupDefaultPickPlane = function () {
                _this.pickPlaneXY.name = exports.DEFAULT_HANDLE_GROUP_NAME.PICK_PLANE_XY;
                _this.pickPlaneYZ.name = exports.DEFAULT_HANDLE_GROUP_NAME.PICK_PLANE_YZ;
                _this.pickPlaneZX.name = exports.DEFAULT_HANDLE_GROUP_NAME.PICK_PLANE_ZX;
            ...
            _this.setupDefaultPick = function () {
                _this.pick.name = exports.DEFAULT_HANDLE_GROUP_NAME.PICK;
                _this.setupHandle(_this.pick);
            };
            _this.setupDefaultEyeRotation = function () {
                _this.rotationEye.name = exports.DEFAULT_HANDLE_GROUP_NAME.ER;
                _this.rotationEye.camera = _this.camera;
                _this.setupHandle(_this.rotationEye);
            };
            _this.setupDefaultTranslation = function () {
                _this.translationXP.name = exports.DEFAULT_HANDLE_GROUP_NAME.XPT;
                _this.translationYP.name = exports.DEFAULT_HANDLE_GROUP_NAME.YPT;
                _this.translationZP.name = exports.DEFAULT_HANDLE_GROUP_NAME.ZPT;
                _this.translationXN.name = exports.DEFAULT_HANDLE_GROUP_NAME.XNT;
                _this.translationYN.name = exports.DEFAULT_HANDLE_GROUP_NAME.YNT;
                _this.translationZN.name = exports.DEFAULT_HANDLE_GROUP_NAME.ZNT;
            ...
            _this.setupDefaultRotation = function () {
                _this.rotationX.name = exports.DEFAULT_HANDLE_GROUP_NAME.XR;
                _this.rotationY.name = exports.DEFAULT_HANDLE_GROUP_NAME.YR;
                _this.rotationZ.name = exports.DEFAULT_HANDLE_GROUP_NAME.ZR;
            ...
            _this.computeObjectBounds = function () {
                ...
                if (_this.useComputedBounds) {
                    if (_this.object.type === "Mesh") {
                        ...
                        var radius = (_a = boundingSphere === null || boundingSphere === void 0 ? void 0 : boundingSphere.radius) !== null && _a !== void 0 ? _a : 0;
            ...
            _this.setDampingFactor = function (dampingFactor) {
                ...
                return (_this.dampingFactor = THREE.MathUtils.clamp(dampingFactor, 0, 1));
            };
            /**
             * @hidden
             */
            _this.processDrag = function (args) {
                ...
                if (handle instanceof TranslationGroup) {
                    ...
                    if (_this.mode === exports.ANCHOR_MODE.FIXED) {
            ...
            _this.updateMatrixWorld = function (force) {
                ...
                _this.objectParentWorldQuaternion.invert();
                ...
                if (_this.mode === exports.ANCHOR_MODE.INHERIT && !_this.isBeingDraggedTranslation) {
            ...
            _this.mode = (_b = (_a = _this.options) === null || _a === void 0 ? void 0 : _a.mode) !== null && _b !== void 0 ? _b : exports.ANCHOR_MODE.FIXED;
            _this.hideOtherHandlesOnDrag = (_d = (_c = _this.options) === null || _c === void 0 ? void 0 : _c.hideOtherHandlesOnDrag) !== null && _d !== void 0 ? _d : true;
            _this.hideOtherControlsInstancesOnDrag = (_f = (_e = _this.options) === null || _e === void 0 ? void 0 : _e.hideOtherControlsInstancesOnDrag) !== null && _f !== void 0 ? _f : true;
            _this.showHelperPlane = (_h = (_g = _this.options) === null || _g === void 0 ? void 0 : _g.showHelperPlane) !== null && _h !== void 0 ? _h : false;
            _this.highlightAxis = (_k = (_j = _this.options) === null || _j === void 0 ? void 0 : _j.highlightAxis) !== null && _k !== void 0 ? _k : true;
            _this.useComputedBounds = (_m = (_l = _this.options) === null || _l === void 0 ? void 0 : _l.useComputedBounds) !== null && _m !== void 0 ? _m : false;
            _this.snapTranslation = (_p = (_o = _this.options) === null || _o === void 0 ? void 0 : _o.snapTranslation) !== null && _p !== void 0 ? _p : {
                x: false,
                y: false,
                z: false
            };
            _this.separation = (_r = (_q = _this.options) === null || _q === void 0 ? void 0 : _q.separation) !== null && _r !== void 0 ? _r : DEFAULT_CONTROLS_SEPARATION;
            _this.isDampingEnabled = (_t = (_s = _this.options) === null || _s === void 0 ? void 0 : _s.isDampingEnabled) !== null && _t !== void 0 ? _t : true;
            _this.rotationRadiusScale = (_v = (_u = _this.options) === null || _u === void 0 ? void 0 : _u.rotationRadiusScale) !== null && _v !== void 0 ? _v : DEFAULT_ROTATION_RADIUS_SCALE;
            _this.eyeRotationRadiusScale = (_x = (_w = _this.options) === null || _w === void 0 ? void 0 : _w.eyeRotationRadiusScale) !== null && _x !== void 0 ? _x : DEFAULT_EYE_ROTATION_SCALE;
            _this.pickPlaneSizeScale = (_z = (_y = _this.options) === null || _y === void 0 ? void 0 : _y.pickPlaneSizeScale) !== null && _z !== void 0 ? _z : DEFAULT_PLANE_SIZE_SCALE;
            _this.translationDistanceScale = (_1 = (_0 = _this.options) === null || _0 === void 0 ? void 0 : _0.translationDistanceScale) !== null && _1 !== void 0 ? _1 : DEFAULT_TRANSLATION_DISTANCE_SCALE;
        ...
        function Raycaster(camera, domElement, controls) {
            ...
            _this.pointerDownListener = function (event) {
                ...
                if ((_a = _this.activeHandle) === null || _a === void 0 ? void 0 : _a.parent) {
                    ...
                    removeEventListener(_this.domElement, ["pointerdown", "touchstart"], _this.pointerDownListener, {
                        capture: true
                    });
                    emitter.emit(exports.EVENTS.DRAG_START, {
                        point: initialIntersectionPoint,
                        handle: _this.activeHandle
                    });
                    addEventListener(_this.domElement, ["pointermove", "touchmove"], _this.pointerMoveListener, {
                        passive: false,
                        capture: true
                    });
                }
            ...
            _this.pointerMoveListener = function (event) {
                ...
                emitter.emit(exports.EVENTS.DRAG, {
                    point: _this.point,
                    handle: _this.activeHandle,
                    dragRatio: dragRatio
                });
            ...
            _this.pointerUpListener = function () {
                var _a, _b, _c, _d;
                removeEventListener(_this.domElement, ["pointermove", "touchmove"], _this.pointerMoveListener, {
                    capture: true
                });
                addEventListener(_this.domElement, ["pointerdown", "touchstart"], _this.pointerDownListener, {
                    passive: false,
                    capture: true
                });
                emitter.emit(exports.EVENTS.DRAG_STOP, { point: _this.point, handle: _this.activeHandle });
                if (((_a = _this.activeHandle) === null || _a === void 0 ? void 0 : _a.parent) &&
            ...
            _this.destroy = function () {
                ...
                removeEventListener(_this.domElement, ["pointerup", "touchend"], _this.pointerUpListener, {
                    capture: true
                });
            };
            ...
            addEventListener(_this.domElement, ["pointerup", "touchend"], _this.pointerUpListener, {
                passive: false,
                capture: true
            });
            return _this;
    ...
    var ControlsManager = /** @class */ (function (_super) {
        ...
        function ControlsManager(camera, domElement) {
            ...
            _this.eventListeners = (_a = {},
                _a[exports.EVENTS.DRAG_START] = [],
                _a[exports.EVENTS.DRAG] = [],
                _a[exports.EVENTS.DRAG_STOP] = [],
                _a);
            _this.listenToEvents = function () {
                emitter.on(exports.EVENTS.DRAG_START, function (_a) {
                    ...
                    _this.eventListeners[exports.EVENTS.DRAG_START].map(function (callback) {
                        callback(controls.object, handle.name);
                    });
                });
                emitter.on(exports.EVENTS.DRAG, function (_a) {
                    ...
                    _this.eventListeners[exports.EVENTS.DRAG].map(function (callback) {
                        callback(controls.object, handle.name);
                    });
                });
                emitter.on(exports.EVENTS.DRAG_STOP, function (_a) {
                    ...
                    _this.eventListeners[exports.EVENTS.DRAG_STOP].map(function (callback) {
                        callback(controls.object, handle.name);
                    });
                });
            };
...
//# sourceMappingURL=three-freeform-controls.umd.js.map
